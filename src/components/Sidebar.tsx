...
import { Home, User, Bell, Bookmark, Settings, Users, BookOpen, MessageSquare, TrendingUp, UserPlus } from 'lucide-react';
  ...
  return (
    <div className="sticky top-24 space-y-8">
      ...
      <div className="bg-purple-900 rounded-3xl p-6 text-white overflow-hidden relative group border border-purple-800/50">
        ...
        <button className="w-full py-2.5 bg-white text-purple-900 font-black rounded-xl text-sm hover:bg-purple-50 transition-colors relative z-10">
          Upgrade Now
        </button>
      </div>
    </div>
