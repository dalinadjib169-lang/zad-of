                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <main className={user ? "lg:col-span-9 xl:col-span-6" : "col-span-12"}>
                      <Routes>
                        ...
                        <Route path="/settings" element={user ? <div className="p-8 bg-slate-900 rounded-3xl border border-slate-800 text-center"><h2 className="text-2xl font-black mb-4">Settings</h2><p className="text-slate-400">Coming soon...</p></div> : <Navigate to="/login" />} />
